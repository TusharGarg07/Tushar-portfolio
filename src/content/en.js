export default {
  hero: {
    ...
    stats: ["4 Production Projects", "3 Live Deployments", "JLPT N3", "AWS & Docker"],
    ...
    cards: {
      focus: { title: "Focus", text: "Production-minded software engineering, backend systems, AI applications, and analytics workflows." },
      domains: { title: "Domains", text: "Finance, manufacturing, environmental analytics, bioinformatics, and full-stack systems." }
    },
    systemStatus: {
      title: "System Status",
  ...
  about: {
    ...
    education: {
      title: "Education",
      items: [
        { degree: "B.Tech in Biotechnology", institution: "Amity University, Noida", duration: "2022–2026", score: "CGPA: 8.6" },
        { degree: "CBSE XII", institution: "DL DAV Model School", score: "89.7%" }
      ]
    }
  },
  projects: [
  ...
  projectButtons: { liveDemo: "Live Demo →", github: "GitHub" },
  experience: {
    heading: "Experience",
  ...
  skills: [
    ...
    { id: "ai-ml", category: "AI & Machine Learning", items: ["XGBoost", "SHAP", "Computer Vision", "TensorFlow", "Scikit-Learn"] },
    { id: "bioinformatics", category: "Bioinformatics", items: ["Biopython", "BLAST", "Computational Genomics", "Genomic Data Analysis"] }
  ],
  certifications: [
    { id: "jlpt-n3", title: "JLPT N3", issuer: "Japanese-Language Proficiency Test", year: "2026" },
    { id: "jlpt-n5", title: "JLPT N5", issuer: "Japanese Language Proficiency Test", year: "2025" },
    { id: "python-data-science", title: "Python for Data Science", issuer: "NPTEL", year: "2025" },
    { id: "microsoft-tech", title: "Microsoft Technical Certification", issuer: "Microsoft", year: "2024" },
    { id: "data-analysis-excel-udemy", title: "Data Analysis & Excel", issuer: "Udemy", year: "2024" },
    { id: "ai-ml-core", title: "AI and Machine Learning Core", issuer: "Certification Program", year: "2024" },
    { id: "full-stack-web", title: "Full Stack Web Development", issuer: "Certification Program", year: "2024" }
  ],
  languages: [
    { name: "English", level: "Professional Proficiency" },
    { name: "Hindi", level: "Native" },
    { name: "Japanese", level: "Intermediate Professional Working Proficiency (JLPT N3 | JLPT N2 Candidate)" },
