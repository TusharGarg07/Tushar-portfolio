export default {
  ...
  about: {
    ...
    paragraphs: [
      "データ処理から機械学習、バックエンド設計、デプロイまで、一貫して開発に関わることを大切にしています。",
      "これまでERPシステムや製造業向けの検査AI、環境モニタリング、バイオインフォマティクスなど幅広い分野でシステム開発を経験しました。",
      "「動くだけ」では満足せず、実環境での信頼性や使いやすさを意識しながら改善を続けることが自分のスタイルです。",
      "技術を通じて、現場で本当に役立つものをつくっていきたいと思っています。"
    ],
    education: {
      title: "学歴",
      items: [
